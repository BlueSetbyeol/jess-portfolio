    ...
    >
      ...
      <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', position: 'relative', zIndex: 1 }}>
        ...
        <a
          ...
          onMouseEnter={e => { e.currentTarget.style.borderColor = 'var(--green)'; e.currentTarget.style.color = 'var(--green)'; e.currentTarget.style.transform = 'translateY(-1px)' }}
          onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(26,23,20,0.2)'; e.currentTarget.style.color = 'var(--fg)'; e.currentTarget.style.transform = 'translateY(0)' }}
        >
      ...
      {/* Tags */}
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem', marginTop: '2.75rem', position: 'relative', zIndex: 1 }}>
        {HERO.tags.map(tag => (
          <span
            key={tag.label}
            style={{
