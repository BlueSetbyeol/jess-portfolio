...
const PROJECTS: Project[] = [
  {
    title: 'Project One',
    description: 'A short description of what this app does and why it matters. Describe the problem it solves and what you learned.',
            ...
            <div style={{ padding: '1.25rem 1.5rem' }}>
              ...
              <div style={{ display: 'flex', gap: '0.6rem' }}>
                ...
                <a
                  ...
                  onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(26,23,20,0.15)'; e.currentTarget.style.color = 'var(--fg)' }}
                >
                  GitHub
                </a>
              </div>
