...
const CONTACT = {
  ...
  sub: "I'm actively looking for my first junior dev role — especially with teams that build with AI in the loop. If that sounds like you, I'd love to connect.",
  links: [
    { label: 'hello@alexdoe.dev', href: 'mailto:hello@alexdoe.dev', variant: 'email' },
    { label: 'GitHub',            href: '#',                         variant: 'neutral' },
    { label: 'LinkedIn',          href: '#',                         variant: 'green' },
